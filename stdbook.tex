...
\begin{enumerate}
	...
	\item  Las frecuencias absolutas acumuladas menor que\index{frecuencias absolutas acumuladas menor que} $F_i$ se obtienen media $$F_m=f_1+f_2+\ldots+f_m=\sum_{i=1}^mf_i$$
