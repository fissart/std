...
Tenga en cuenta que $n$ es el número de datos, es decir $$n=f_1+f_2+\ldots+f_r=\sum_{i=1}^rf$$ donde $f_i$ es número de datos en la partición $X_i$, una de las $r$ particiones del conjunto total de datos.
