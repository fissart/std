...
\begin{enumerate}
	...
	\item  Las frecuencias absolutas relativas mayor que son $$H_m^*=\frac{F_m}{n}$$
	\item  Las frecuencias absolutas relativas porcentuales son $h_i\%=100\cdot h_i$
	\item  Las frecuencias absolutas relativas menor que porcentuales  $H_i\%=100\cdot H_i$
	\item  Las frecuencias absolutas relativas mayor que porcentuales obedecen a la fórmul $H_i^*\%=100\cdot H_i^*$
